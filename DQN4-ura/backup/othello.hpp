...
vector<Board> random_play_boards(const int number, const Neuralnet &neuralnet, const int search_depth, const int bottom_disks, const int top_disks, const double random, const double cut_ratio);
