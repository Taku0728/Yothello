...
double AB_value(Board &b, const Neuralnet &neuralnet, const int disks, const int depth, double alp, double bet, const double cut_ratio, vector<pair<int, int> > &route);

double AB_value(map<string, pair<double, double> > &book, Board &b, const Neuralnet &neuralnet, const int disks, const int depth, double alp, double bet, const double cut_ratio);

double AB_value(Board &b, const Neuralnet &neuralnet, const int disks, const int depth, double alp, double bet, const double cut_ratio);

double AB_move(map<string, pair<double, double> > book, Board &b, const Neuralnet &neuralnet, const int disks, const int depth, const double random, const double cut_ratio);

vector<Board> next_boards(const Board &b);

vector<Board> next_boards(const Board &b, const vector<pair<int, int> > &moves);

vector<pair<int, int> > next_moves(Board &b);
...
vector<Board> random_play_boards(const int number, map<string, pair<double, double> > &book, const Neuralnet &neuralnet, const int search_depth, const int bottom_disks, const int top_disks, const double random, const double cut_ratio);

vector<Board> random_play_boards(const int number, map<string, pair<double, double> > &book, const Neuralnet &neuralnet, const int search_depth, const double random, const double cut_ratio);

Board to_board(string s);

string to_test(Board b);
