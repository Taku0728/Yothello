...
int main()
{
	string folder2("vn_206x8^5\\");
	string folder1("vn_206x8^5\\");
	int wins1(0);
	int wins2(0);
	double ew = 18;
	for (int tries(0); tries < 1;++tries) {
		...
		file << folder1 << "," << wins1 << "," << endl;
		file << folder2 << "," << wins2 << "," << endl << endl;
		cout << folder1 << "," << wins1 << "," << endl;
		cout << folder2 << "," << wins2 << "," << endl << endl;
	}
