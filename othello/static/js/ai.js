(function(global) {
  ...
  function renew_record() {
    ...
    var tie = 0;
    $.ajax({
      url: "https://othello.to-kei.net/api/post.php?type=strong",
      type: "GET"
    })
      // Ajaxリクエストが成功した時発動
      .done(data => {
  ...
  function EndProcess(state) {
    ...
    switch (result) {
      case 1:
        text = "強いオセロAIに" + String(-score) + "石で勝った！";
        break;
      case -1:
        text = "強いオセロAIに" + String(score) + "石で負けた！";
        break;
      case 0:
        text = "強いオセロAIに引き分けた！";
        break;
    ...
    var html =
      '<p id="tweet-share" class="center"><iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" style="position: static; visibility: visible; width: 61px; height: 20px;" title="Twitter Tweet Button" src="https://platform.twitter.com/widgets/tweet_button.0639d67d95b7680840758b6833f06d87.en.html#dnt=false&amp;hashtags=%E6%9C%80%E5%BC%B1%E3%82%AA%E3%82%BB%E3%83%AD&amp;id=twitter-widget-0&amp;lang=en&amp;original_referer=http%3A%2F%2Fothello.to-kei.net&amp;size=m&amp;text=' +
      text +
      '&amp;type=share&amp;url=http%3A%2F%2Fothello.to-kei.net"></iframe></p>';
